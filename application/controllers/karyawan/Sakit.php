...
class Sakit extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','pengguna_non_level/sakit/sakit_list', $data);
    }
    ...
    public function create() 
    {
        ...
        $this->template->load('template','pengguna_non_level/sakit/sakit_form', $data);
    }
	...
	public function get_user_by_name_or_username() {
		...
		$data = $this->Tbl_sakit_model->get_user_by_name_or_username($keyword);
