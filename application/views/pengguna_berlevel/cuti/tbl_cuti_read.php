...
<h4 class="panel-title">Tbl_cuti Read</h4>
...
<table id="data-table-default" class="table table-hover table-bordered table-td-valign-middle">
	    ...
	    <tr><td></td><td><a href="<?php echo site_url(levelUser($this->session->userdata('level')).'/cuti') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
			</div>
        </div>
    </div>
