    ...
    <div class="col-md-4">
      <div class="widget widget-stats bg-gradient-cyan-blue">
        ...
        <div class="stats-content">
          ...
          <div class="stats-number"> <?= count_users_active($this->session->userdata('id_lapangan_yang_dikoordinir'))['jumlah']; ?> Orang</div>
          <div class="stats-progress progress">
			...
			<div class="widget widget-stats bg-gradient-indigo">
				...
				<div class="stats-content">
					...
					<div class="stats-number"><?= count_total_absensi_users($this->session->userdata('id_lapangan_yang_dikoordinir'))['jumlah'] ?></div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 100%;"></div>
					</div>
				</div>
