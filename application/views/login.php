	...
	<div id="app" class="app">
		...
		<div class="login login-v2 fw-bold">
			...
			<div class="login-cover">
				<div class="login-cover-img" style="background-image: url(assets/assets/img/login-bg/login-bg-13.jpg)" data-id="login-cover-image"></div>
				...
				<div class="login-header">
					<div class="brand">
						<div class="d-flex align-items-center">
							<span class="logo"></span>Absen Karyawan
						</div>
